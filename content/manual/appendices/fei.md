...
In addition to the tuner control functions, when the device is of type RX_SCANNER_DIGITIZER, there are additional control functions.

###### Additional Scanner Tuner Control Functions
| **Function Prototype**                 | **Description** |
| :----------------------- | :------- |
...
When a device is of type RX_SCANNER_DIGITIZER, there are additional fields that the tuner status structure must support.
