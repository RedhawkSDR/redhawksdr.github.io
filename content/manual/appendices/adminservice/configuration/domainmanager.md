...
description: Specifies that all running applications and components bind to the Domain Manager process instead of the NamingService. This assists with high frequency deployments of waveforms and components.
